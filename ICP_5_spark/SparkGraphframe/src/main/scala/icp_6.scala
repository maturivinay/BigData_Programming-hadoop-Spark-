...
object icp_6 {
  def main(args: Array[String]) {
    ...
    val spark = SparkSession
      ...
      .getOrCreate()
    val input = spark.read.format("csv").option("header", "true").load("C:\\Users\\matur\\Desktop\\UMKC\\bigdata_programming\\ICP_5_spark\\station_data.csv")

    //input.show()
    val input1 = input.select("name","landmark","dockcount").withColumnRenamed("name","id")
    //input1.show()

    val output = spark.read.format("csv").option("header", "true").load("C:\\Users\\matur\\Desktop\\UMKC\\bigdata_programming\\ICP_5_spark\\trip_data.csv")
    //output.show()
    ...
    //g.vertices.write.csv("C:\\Users\\matur\\Desktop\\UMKC\\bigdata_programming\\ICP_5_spark\\SparkGraphframe\\src\\main\\ver")
    //g.edges.write.csv("C:\\Users\\matur\\Desktop\\UMKC\\bigdata_programming\\ICP_5_spark\\SparkGraphframe\\src\\main\\edge")
